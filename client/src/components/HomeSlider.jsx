  ...
  return (
    <div className='z-0'>
      <div className="homeBackground relative h-[100vh] overflow-hidden flex flex-col  justify-center">
        ...
        <div className="HomeSlider--button px-6 py-4 w-[180px] bg-white text-black text-center rounded-2xl uppercase  font-Inter font-semibold cursor-pointer">{props.item.type}</div>
        </div>
